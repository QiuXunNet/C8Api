...
namespace Qiuxun.C8.Api.Controllers
{
    ...
    public class LeaderboardController : QiuxunApiController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ApiResult<RankIntegralResDto> GetMyRank(string queryType, int userId)
        {
            var result = new ApiResult<RankIntegralResDto>();
            result.Data = _service.GetMyRank(queryType,userId);
            return result;
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public ApiResult<RankIntegralResDto> GetMyHighMaster(string queryType, int lType, int userId)
        {
            var result = new ApiResult<RankIntegralResDto>();
        ...
        /// <returns></returns>
        [HttpGet]
        public ApiResult<RankIntegralResDto> GetMyProfitReward(string queryType, int RType, int lType, int userId)
        {
            var result = new ApiResult<RankIntegralResDto>();
