...
namespace Qiuxun.C8.Api.Controllers
{
    ...
    public class RechargeController : QiuxunApiController
    {
        ...
        public ApiResult GetWxInfo(int money)
        {
            ...
            notifyUrl = HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Host + ":" + HttpContext.Current.Request.Url.Port + "/api/Recharge/WxNotify";
        ...
        public ApiResult GetZfbInfo(int money)
        {
            ...
            if (_service.AddComeOutRecord(zFBResDto.OrderId, money, 2, (int)this.UserInfo.UserId))
            {
                ...
                request.SetNotifyUrl(HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Host + ":" + HttpContext.Current.Request.Url.Port + "/api/Recharge/AsyncPay");
